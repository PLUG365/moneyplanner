...
iPhoneのdev-clientビルドで開く。iPhone側の接続操作、リロード方法、取引の読み書きに触る変更の定型確認項目は [docs/development-setup.md](docs/development-setup.md#dev-clientでの動作確認) を参照する。TestFlight検証中のビルド情報は [PLAN.md](PLAN.md) を参照する。
